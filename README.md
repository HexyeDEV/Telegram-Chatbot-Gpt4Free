...
This is a Python-based Telegram bot using the telethon library. The bot responds to messages using the GPT4FREE repo. This bot also supports plugins, roles and long term memory via vector database
